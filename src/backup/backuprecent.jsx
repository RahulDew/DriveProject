    ...
    <div className=" ml-20 text-center bg-[#E2EFFF] min-h-screen p-6 lg:px-8">
      ...
      <div className="px-5">
        <div className="flex justify-between items-center my-4 ">
          <h3 className="text-xl font-semibold">Search your Files: </h3>
          <input
            onChange={handleFileSearch}
            type="text"
            placeholder="Enter name of file..."
            className="w-10/12 py-2 px-4 bg-slate-400 bg-opacity-30 hover:bg-opacity-40 duration-200 outline-none border-none text-base rounded-md"
          />
        </div>
        ...
        {!searchText ? (
          <>
            <div className="my-5">
              <h1 className="text-xl font-semibold">Recent Files</h1>
            </div>
            {!loading ? (
              <>
                {recentFiles.length ? (
          ...
          <>
            <div className="my-5 flex gap-5 items-center">
              <h1 className="text-xl font-semibold">Search Files for:</h1>
