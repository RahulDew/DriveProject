      ...
      {folderModal && (
        <PopupWrapper handleWrapperClose={handleCloseFolderModel}>
          <motion.div
            ...
            className="w-full relative transform overflow-hidden mx-5 sm:mx-auto rounded-xl bg-white dark:bg-slate-900 text-slate-950 dark:text-slate-50 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg"
          >
            {/* main content */}
